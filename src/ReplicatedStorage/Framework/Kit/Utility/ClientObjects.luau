...
--[=[
	...
	custom etom function, courtesy of yours truly
]=]
function ClientObjects.scanV5(targetScope: Scope, path: Instance)
	ScopeUtil.assertScope(targetScope, "ClientObjects.scanV5()")
